#!/usr/bin/env julia
#==============================================================================#
# VACASK Benchmark: Diode Voltage Multiplier — OSDI variant
#
...
const circuit_code = parse_spice_file_to_mna(spice_file; circuit_name=:mul_osdi_circuit,
...
function setup_simulation()
    wrapped_setup = (params) -> Base.invokelatest(mul_osdi_circuit, params)
