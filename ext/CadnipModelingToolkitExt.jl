module CadnipModelingToolkitExt
using Cadnip
using ModelingToolkit
using Cadnip: AbstractNet, defaultscope, kcl!
using DAECompiler
...
macro Cadnip.declare_MSLConnector(mtk_model, pin_ports...)
    checks = Expr[]
...
# This is a generic default that automatically maps from Cadnip.AbstractsNets to the normal generated MTKConnector
